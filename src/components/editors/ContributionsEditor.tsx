...
export function ContributionsEditor({ data, onChange }: ContributionsEditorProps) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <Label htmlFor="contributions-username" className="text-xs uppercase tracking-wide font-medium">GitHub Username</Label>
        <div className="flex gap-2 mt-1.5">
          <Input
            id="contributions-username"
            value={data.username}
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center space-x-2">
          <Checkbox
            ...
            onCheckedChange={(checked) => onChange({ ...data, hideTitle: checked })}
          />
          <label htmlFor="hide-title" className="text-sm cursor-pointer">
            Hide Title
          </label>
        </div>
      </div>
